...
def main():
    ...
    print(f'after rent, revenue: {restaurant.revenue},balance: {restaurant.balance}, expense: {restaurant.expense}')

    restaurant.pay_salary(chef)
    print(f'after salary, revenue: {restaurant.revenue}, balance: {restaurant.balance}, expense: {restaurant.expense}')
